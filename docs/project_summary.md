...
4. **WordPress CMS Tracking Integration (`[ma_tracking]`)**:
   - Packaged as standalone WordPress plugin `wp-plugin/ma-logistics-tracking/` deployed to `https://website.granthinfotech.online/track-your-order/`.
   - Embeds into Elementor via Shortcode widget `[ma_tracking]`, keeping all static copy, banners, and FAQs manageable in WordPress CMS while MA Logistics ERP serves as the live tracking single source of truth.
   - Includes automatic URL deep-linking (`?awb=...`), copyable share links, route visualization, and responsive vertical milestone event timelines.
...
| **Tracking & POD** | [TrackingController.php](file:///d:/Company%20Work/Company%20projects/MAlogistic/app/Controllers/TrackingController.php), [TrackingApi.php](file:///d:/Company%20Work/Company%20projects/MAlogistic/app/Controllers/Api/TrackingApi.php) | — | [TrackingStatusLogModel.php](file:///d:/Company%20Work/Company%20projects/MAlogistic/app/Models/TrackingStatusLogModel.php), [BookingModel.php](file:///d:/Company%20Work/Company%20projects/MAlogistic/app/Models/BookingModel.php) | [tracking_drawer.php](file:///d:/Company%20Work/Company%20projects/MAlogistic/app/Views/logistics/tracking_drawer.php), [public_track.php](file:///d:/Company%20Work/Company%20projects/MAlogistic/app/Views/public_track.php) |
| **WordPress CMS Tracking** | External WordPress Client | — | Single Source of Truth: ERP Database | Shortcode `[ma_tracking]`, `wp-plugin/ma-logistics-tracking/` |
