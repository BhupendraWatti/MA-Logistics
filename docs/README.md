# M.A. Logistics ERP (MARL EXPRESS ERP) — Project Documentation Entry Point

Welcome to the project documentation for **M.A. Logistics ERP (MARL EXPRESS ERP)**.

## Mandatory Startup Reading Order for AI Agents
...
> [!IMPORTANT]
> The project documentation is a permanent part of the codebase.
> Whenever code is added, modified, removed, or refactored, the affected documentation files must be updated immediately to remain strictly synchronized with the codebase.
...
| **`changes.md`** | Living changelog tracking all technical implementations. |
| **`database.md`** | Full database schemas, relationships, indexes, and model maps. |
| **`api.md`** | Comprehensive public and internal REST/JSON API documentation. |
| **`known-issues.md`** | Registry of known technical issues, limitations, and workarounds. |
| **`testing.md`** | Testing procedures, regression suites, and load test execution guide. |
